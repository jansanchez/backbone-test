...
Urb.Views.GalleryView = Backbone.View.extend({
	...
	addOne : function(modelo){
		...
		var view = new Urb.Views.galleryRow({model : modelo});
...
Urb.Views.galleryRow = Backbone.View.extend({
	className : 'thumb',
	model : null,
	events: {
    ...
    deleteImage: function(){
    	...
    	Ins.Models.Collections.imagesCollection.remove(this.model);
    },
